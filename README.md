...
- Queries a catalog, default `IV/39/tic82`.
...
- Computes measured RMS per TIC ID.
...
```bash
python noise_model_W1m.py --cam configs/qhy600.json --bin-size 1
```
...
- Plots measured RMS against magnitude.
...
```bash
python plot_noise_model_W1m.py noise_model_NG0719+0956_qhy600_bin1.json
```
